/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 079e0e54cd6ab6fa86b2a5423486efbf)
// Runtime types generated with workerd@1.20260730.1 2026-06-14 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	AI: Ai;
	GroupAgent: DurableObjectNamespace<import("./src/index").GroupAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GroupAgent";
	}
